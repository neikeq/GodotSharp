...
%typemap(cscode) SpatialSound2DServerSW %{
  internal $csclassname() {}

%}

%typemap(csconstruct, excode=SWIGEXCODE) SpatialSound2DServerSW %{: this(false) {
...
%nodefaultdtor SpatialSound2DServerSW;
