...
namespace GodotEngine
{
    ...
    public class Curve3D : Resource
    {
        ...
        public override void Dispose()
        {
            lock (this)
            {
                if (ptr != IntPtr.Zero)
                {
                    ...
                    {
                        memoryOwn = false;
                    NativeCalls.godot_icall_Curve3D_Dtor(ptr);
                        ptr = IntPtr.Zero;
                    }
                }
        ...
        public void add_point(Vector3 pos, Nullable<Vector3> @in = null, Nullable<Vector3> @out = null, int atpos = -1)
        {
            ...
            NativeCalls.godot_icall_4_196(method_bind_1, Object.GetPtr(this), ref pos, ref @in_in, ref @out_in, atpos);
        }
        ...
        {
            NativeCalls.godot_icall_2_197(method_bind_2, Object.GetPtr(this), idx, ref pos);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_1_2(method_bind_3, Object.GetPtr(this), idx);
            return (Vector3)ret;
        }
        ...
        {
            NativeCalls.godot_icall_2_36(method_bind_4, Object.GetPtr(this), idx, tilt);
        }
        ...
        {
            return NativeCalls.godot_icall_1_3(method_bind_5, Object.GetPtr(this), idx);
        }
        ...
        {
            NativeCalls.godot_icall_2_197(method_bind_6, Object.GetPtr(this), idx, ref pos);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_1_2(method_bind_7, Object.GetPtr(this), idx);
            return (Vector3)ret;
        }
        ...
        {
            NativeCalls.godot_icall_2_197(method_bind_8, Object.GetPtr(this), idx, ref pos);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_1_2(method_bind_9, Object.GetPtr(this), idx);
            return (Vector3)ret;
        }
        ...
        private IntPtr method_bind_11 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "interpolate");
        ...
        {
            object ret = NativeCalls.godot_icall_2_198(method_bind_11, Object.GetPtr(this), idx, t);
            return (Vector3)ret;
        }

        private IntPtr method_bind_12 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "interpolatef");
        ...
        {
            object ret = NativeCalls.godot_icall_1_199(method_bind_12, Object.GetPtr(this), fofs);
            return (Vector3)ret;
        }

        private IntPtr method_bind_13 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_bake_interval");
        ...
        {
            NativeCalls.godot_icall_1_45(method_bind_13, Object.GetPtr(this), distance);
        }

        private IntPtr method_bind_14 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_bake_interval");
        ...
        private IntPtr method_bind_15 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_baked_length");
        ...
        private IntPtr method_bind_16 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "interpolate_baked");
        ...
        {
            object ret = NativeCalls.godot_icall_2_200(method_bind_16, Object.GetPtr(this), offset, cubic);
            return (Vector3)ret;
        }

        private IntPtr method_bind_17 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_baked_points");

        /// <summary>
        /// Returns the cache of points as a [Vector3Array].
        /// </summary>
        public List<Vector3> get_baked_points()
        {
            Vector3[] ret = NativeCalls.godot_icall_0_168(method_bind_17, Object.GetPtr(this));
            return new List<Vector3>(ret);
        }

        private IntPtr method_bind_18 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_baked_tilts");

        /// <summary>
        /// Returns the cache of tilts as a [RealArray].
        /// </summary>
        public List<float> get_baked_tilts()
        {
            float[] ret = NativeCalls.godot_icall_0_164(method_bind_18, Object.GetPtr(this));
            return new List<float>(ret);
        }

        private IntPtr method_bind_19 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "tesselate");
        ...
        /// </summary>
        public List<Vector3> tesselate(int max_stages = 5, float tolerance_degrees = 4)
        {
            Vector3[] ret = NativeCalls.godot_icall_2_201(method_bind_19, Object.GetPtr(this), max_stages, tolerance_degrees);
            return new List<Vector3>(ret);
        }
    }
}
